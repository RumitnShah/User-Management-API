...
# @obj.route('/v1/users')  ##To get all the users.
# def Users():
#     with open('database.json', 'r') as file:
#         data = json.load(file)
#     return jsonify(data)

# @obj.route('/v1/users/ID')   # To get users with specific id only
# def user_id():
...
@obj.route('/v1/users/teams')     #To get users with same team code
def user_team():
